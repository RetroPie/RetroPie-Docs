...
|Vice|C64|?|?|?|?|
|Cave Story|Cave Story|YES|YES|YES|The game itself|
|prboom|Doom|YES|YES|YES|Doom.wad|
|eDuke32|Duke3D|YES|YES|YES|Duke 3d Shareware|
|Gambatte-libretro|Gameboy|YES|YES|YES|Tetris.gb|
|GPSP|Gameboy Advance|YES|YES|YES|Zelda - The Minish gba|
...
|PCSX ReArmed|PSX|YES|YES|YES|R4 - Ridge Racer Type 4.img|
|rpix86|PC|?|?|?|?|
|ScummVM|ScummVM|?|?|?|?|
|Fuse|ZXMachine|?|?|?|?|
