...
## Installation
**Feb. 2022 - Note for Pi 4 and Zero 2W:** Recent Pi 4 boards, and the new Pi Zero 2W, require newer software and are not compatible with the official 4.7.1 image downloads. You may install manually (use the legacy "Buster" OS), or use the latest unsupported weekly builds at https://files.retropie.org.uk/images/weekly/ (use the `rpi4_400.img.gz` file for Pi 4, or `rpi2_3_zero2w.img.gz` for the Zero 2W.)
