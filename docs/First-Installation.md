...
You will use a program called [Win32DiskImager](http://sourceforge.net/projects/win32diskimager/) to install the RetroPie 3.0 SD image on your MicroSD card. (You may need a MicroSD card reader to plug it into your computer)
...
- if on windows type \\\yourpiIPaddress into the computer folder (i.e. \\\192.168.0.107) or (\\\RETROPIE) if you can't figure out your IP address.
