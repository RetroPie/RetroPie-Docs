...
This emulator can be installed from the experimental menu of the [https://github.com/RetroPie/RetroPie-Setup/wiki/Updating-RetroPie#using-the-retropie-setup-script](RetroPie-Setup script.)
