...
Although the SNES cores may not always be the best candidates for these settings, below is a graph depicting the affect they can potentially have, using 'Super Mario World' as an example.
