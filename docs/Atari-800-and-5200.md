...
| :---: | :---: | :---: | :---: | :---: |
| [Atari800](http://atari800.sourceforge.net/)  | atari800 **or** atari5200  | .a52 .bas .bin .xex .atr .xfd .dcm .atr.gz .xfd.gz | ATARIXL.ROM **and** ATARIBAS.ROM **and** ATARIOSA.ROM **and** ATARIOSB.ROM **and** 5200.rom | /opt/retropie/configs/.atari800.cfg |
