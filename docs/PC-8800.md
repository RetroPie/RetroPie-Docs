...
If you also add the next 2 files, you will have the menus in Japanese kanji characters [Quasi88]:
(Don't use them if you want the menus displayed in English !)
