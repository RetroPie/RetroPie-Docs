...
**However, these incompatibilities are not an issue when using xboxdrv as a calibration and key-mapping tool for any number of gamepads, including the XBox 360 controller, [as detailed here](https://github.com/retropie/retropie-setup/wiki/Universal-Controller-Calibration-&-Mapping-Using-xboxdrv). When used this way, it's even possible for both xpad and xboxdrv to coexist together.**
