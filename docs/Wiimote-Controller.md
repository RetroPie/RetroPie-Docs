...
Please note [this comment](https://github.com/retropie/RetroPie-Setup/issues/256#issuecomment-32708108) about `hid-wiimote` in old 3.6.y kernel, [(unofficial) classic controller](http://www.thinkgeek.com/product/f3a7/) support, D-Pad adaptation to help with RetroArch, script to handle Wii leds numerotation.
