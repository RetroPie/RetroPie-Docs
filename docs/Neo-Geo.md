...
To be honest it is easier to use Final Burn Alpha as an emulator for Neo Geo. Using the correct FBA-Libretro romset some Neo Geo games still do not work.
