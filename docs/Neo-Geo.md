...
For Neo Geo games you can use either the standalone emulators PiFBA and GnGeo-Pi or the Retroarch core FBA-libretro.For more details on FBA-libretro see [this page](https://github.com/petrockblog/RetroPie-Setup/wiki/FinalBurn-Alpha) 
