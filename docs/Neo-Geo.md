...
***
## Emulators: [GnGeo-Pi](https://github.com/ymartel06/GnGeo-Pi), [PiFBA](http://sourceforge.net/projects/pifba/), [fba-libretro](https://github.com/libretro/fba-libretro)

For Neo Geo games you can use either the standalone emulators PiFBA and GnGeo-Pi or the Retroarch core FBA-libretro. FBA-Libretro is recommended because you can force 4:3 aspect ratio and also use shaders. For more details on FBA-Libretro see [this page.](https://github.com/petrockblog/RetroPie-Setup/wiki/FinalBurn-Alpha) 
