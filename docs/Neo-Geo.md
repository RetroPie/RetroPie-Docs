...
During the rom boot up, hit the Neo Geo buttons B + C + D this time to bring up the Test Mode screen. Here you can change all of the gameplay settings such as difficulty and add blood. When you save this, it again will be there even after a full system reboot so you can edit to your liking and not have to do it again. Hope this helps, took a while for me to figure everything out on this!
