...
The BIOS files needed are: **dc_boot.bin, dc_flash.bin**. The BOOT file is often found named something else such as **dc__bios_.bin** and must be renamed to dc_**boot**.bin when placed in the BIOS folder.
