...
To enable music in your Doom games running in lr-prboom, you need to copy MP3s with specific names into the same folder your WAD for the game is located.
