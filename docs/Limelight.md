...
Limelight has been supplanted by [Moonlight](https://github.com/moonlight-stream), for which there is no current, official support.
...
pi@retropie ~/limelight $ **sudo apt update && sudo apt install oracle-java8-jdk** 
﻿
