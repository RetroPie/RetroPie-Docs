...
This emulator is experimental and can be installed from the experimental menu of the [retropie setup script](Updating-RetroPie). This cannot be installed on the Raspberry Pi 4, 400, or any newer generation of RPI hardware.
