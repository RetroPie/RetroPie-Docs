...
[Refer to here: Connection issues and input lags especially if you connect more than one BT device](Bluetooth-Controller#connection-issues-and-input-lags-especially-if-you-connect-more-than-one-bt-controller)
