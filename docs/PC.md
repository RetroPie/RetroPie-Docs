...
[How to add games to RetroPie and launch them from EmulationStation using shell scripts.](http://dosonthepi.blogspot.co.uk/2015/01/run-dos-games-in-retropie_15.html#add-dosgames)
