...
If you can't access the theme changer in emulationstation because it's a white screen, you can [ssh](https://github.com/RetroPie/RetroPie-Setup/wiki/SSH) into the pi and change the theme name back to carbon in the backend in `/opt/retropie/configs/all/emulationstation/es_settings.cfg`
...
|**Io**|<sub><img src="http://i.imgur.com/kfg0T1s.png" width="500"><img src="http://i.imgur.com/l3RCl4U.png" width="500"></sub>|
